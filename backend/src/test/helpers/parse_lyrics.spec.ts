...
//   const title = 'More Like Jesus'

//   it('parses the correct number of slides', () => {
//     // Arrange - Act
//     const slides = parseLyrics(lyrics, title)
//     // Assert
...
//   it('sets the caption to the song title', () => {
//     // Arrange - Act
//     const slides = parseLyrics(lyrics, title)
//     // Assert
//     expect(slides.every(slide => slide.caption == title)).to.be.true
//   })
...
//     const slides = parseLyrics(lyrics, title)
//     // Assert
//     expect(slides[0].heading).to.eql('v1')
//     expect(slides[19].heading).to.eql('b1')
//   })

//   it('parses single verse lyrics', () => {
//     // Arrange - Act
//     const slides = parseLyrics(singleVerseLyrics, title)
//     // Assert
